...
public class AddInventoryJPanel extends javax.swing.JPanel {
    ...
    private Batch batch;
    public AddInventoryJPanel(JPanel userProcessContainer, EcoSystem business, ManufacturerEnterprise enterprise) {
        initComponents();
     ...
     private void populateTable(){
        ...
        for(Batch b: enterprise.getInventory().getBatchList()){
            ...
            row[3] = b.getPharmacy().getQuantity();
            row[4] = b.getPharmacy().getStock();
            row[5] = b.getPharmacy().getPrice() * b.getPharmacy().getQuantity();
            row[6] = b.getPharmacy().getFixedQty();
            dtm.addRow(row);
    ...
    private void populateCmbVaccine(){
        ...
        for(Pharmacy vaccine: enterprise.getVaccineCatalog().getPharmacyList()){
           ...
           @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("Calling Action Listener ");
                          Pharmacy vaccine = (Pharmacy) cmbVaccine.getSelectedItem();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("     Add Medicines to the Inventory");
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 30, 370, 40));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 100, 30));
        ...
        jPanel1.add(cmbVaccine, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 270, 30));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("Medicine Name");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 120, -1));

        txtQuantity.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        txtQuantity.setEnabled(false);
        jPanel1.add(txtQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 270, 30));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("Medicine# ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 110, -1));

        txtBatch.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        txtBatch.setEnabled(false);
        jPanel1.add(txtBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 310, 270, 30));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Batch Number");
        jLabel4.setEnabled(false);
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 130, -1));

        btnAddVaccine.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        btnAddVaccine.setText("Add Medicine>>");
        btnAddVaccine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddVaccineActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddVaccine, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 180, 150, 30));
        ...
        jPanel1.add(btnAddAnother, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 220, 150, 30));
        ...
        VaacineJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Batch Number", "Medicine Code", "Medicine Name", "Medicine#", "Stock Status", " Cost#", "Std Batch#"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 520, 710, 250));
        ...
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 220, 270, 30));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel7.setText("Price Per Medicine");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 370, 130, -1));

        txtPrice.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel1.add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 360, 270, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 470, 130, 30));
        ...
        jPanel1.add(txtStdSize, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 410, 270, 30));
    ...
    private void btnAddVaccineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddVaccineActionPerformed
        ...
        try{
            ...
            Pharmacy v = batch.getPharmacy();
            //txtQuantity.setText(vaccine.getQuantity()+"");
            //batch = new Batch();

            //            for(Pharmacy vaccineOriginal: enterprise.getVaccineCatalog1().getVaccineList()){
