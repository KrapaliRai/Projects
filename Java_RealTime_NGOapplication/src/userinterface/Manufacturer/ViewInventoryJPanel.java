...
public class ViewInventoryJPanel extends javax.swing.JPanel {
    ...
    public ViewInventoryJPanel(JPanel userProcessContainer, EcoSystem business, ManufacturerEnterprise enterprise) {
        initComponents();
   ...
   private void populateTable(){
        ...
        for(Batch b: enterprise.getInventory().getBatchList()){
            ...
            dtm.addRow(row);
            totalInventory = b.getPharmacy().getQuantity() + totalInventory;
        ...
        for(Batch b: enterprise.getInventory().getBatchList()){
            System.out.println("Batch :" + b.getPharmacy().getName() + " Number : " + b.getPharmacy().getQuantity() );
           if(vaccineNameVsNumber.containsKey(b.getPharmacy().getName())){
              String VaccineName = b.getPharmacy().getName();
              Integer temp = vaccineNameVsNumber.get(b.getPharmacy().getName());
               System.out.println("qty from previous hashmap : " + temp);
              temp += b.getPharmacy().getQuantity();
              ...
              vaccineNameVsNumber.put(VaccineName,temp);
                ...
                System.out.println("PUT2: " + b.getPharmacy().getName() + " :: " + b.getPharmacy().getQuantity());
               vaccineNameVsNumber.put(b.getPharmacy().getName(),b.getPharmacy().getQuantity());
           }
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 40, 380, 37));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 920, 190));
        ...
        jPanel1.add(txtTotalQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 350, 180, 30));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 110, 30));
        jPanel1.add(PanelChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 380, 770, 440));
